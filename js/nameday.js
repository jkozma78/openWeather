...
// document.writeln('<font color="#000000" size="5"><b>' + ev + '. ' + honev(ho) + ' ' + nap + '. ' + napnev(ido.getDay()+1) + ', Ma <font color="#ff6666"> ' + havinev(ev, ho, nap) + '</font>, holnap<font color="#ff6666"> ' + havinev(ev,ho, nap+1) + '</font> ünnepli a névnapját.</b></font>')
let nameday=document.querySelector("div.nevnap");
nameday.innerHTML='<font color="#212529" size="2">' + ev + '. ' + honev(ho) + ' ' + nap + '. ' + napnev(ido.getDay()+1) + ', Ma <font color="#ff6666"> ' + havinev(ev, ho, nap) + '</font>, holnap<font color="#ff6666"> ' + havinev(ev,ho, nap+1) + '</font> ünnepli a névnapját.</b></font>';
